...
Gem::Specification.new do |s|
  ...
  s.version     = '1.1.0'
  s.summary     = 'Reworked the contact_us gem to add a basic contact us form to Solidus.'
  s.description = 'Reworked the contact_us gem to add a basic contact us form to Solidus.'
